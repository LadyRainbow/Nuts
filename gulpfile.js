var gulp = require('gulp'),
    ...
    imagemin = require('gulp-imagemin'), //минифицируем картинки
    pngquant    = require('imagemin-pngquant'), // Подключаем библиотеку для работы с png
     cache       = require('gulp-cache'); // Подключаем библиотеку кеширования

    const FileInjector = require('./fileInjector');
    const workingDirectoryFI = 'E:\\Codyu\\Димас_КО\\Орешек\\Nuts\\app\\pages';
    const urlBaseDirectoryFI = 'E:\\Codyu\\Димас_КО\\Орешек\\Nuts\\app';
    const templatesDirectoryFI = 'E:\\Codyu\\Димас_КО\\Орешек\\Nuts\\app\\template';
...
gulp.task('img', function() {
    return gulp.src('app/images/**/*') // Берем все изображения из app
        ...
        .pipe(gulp.dest('app/build/img')); // Выгружаем на продакшен
});
...
gulp.task('watch', ['sass', 'img', 'htmlhint', 'fileInjector'], function(){
